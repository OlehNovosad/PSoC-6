...
#define SAR_CH0_CONFIG (CY_SAR_POS_PORT_ADDR_SARMUX | CY_SAR_CHAN_POS_PIN_ADDR_3 | CY_SAR_NEG_PORT_ADDR_SARMUX | CY_SAR_CHAN_NEG_PIN_ADDR_2 | CY_SAR_CHAN_DIFFERENTIAL_UNPAIRED | CY_SAR_CHAN_AVG_ENABLE | CY_SAR_CHAN_SAMPLE_TIME_0)
#define SAR_CH1_CONFIG (CY_SAR_POS_PORT_ADDR_SARMUX | CY_SAR_CHAN_POS_PIN_ADDR_1 | CY_SAR_NEG_PORT_ADDR_SARMUX | CY_SAR_CHAN_NEG_PIN_ADDR_0 | CY_SAR_CHAN_DIFFERENTIAL_UNPAIRED | CY_SAR_CHAN_AVG_ENABLE | CY_SAR_CHAN_SAMPLE_TIME_1)
#define SAR_MUX_SWITCH (0u | CY_SAR_MUX_FW_P1_VPLUS | CY_SAR_MUX_FW_P3_VPLUS | CY_SAR_MUX_FW_P0_VMINUS | CY_SAR_MUX_FW_P2_VMINUS)
